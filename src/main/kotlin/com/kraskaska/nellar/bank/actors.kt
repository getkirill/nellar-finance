...
import com.kraskaska.nellar.bank.Bank.Companion.etherealActor
...
data class Actor(val id: UUID) {
    ...
    fun deposit(bank: Bank, amount: Long) {
        etherealActor.instantPromiseTo(this, bank, amount)
    }
    fun withdraw(bank: Bank, amount: Long) {
        instantPromiseTo(etherealActor, bank, amount)
    }
